...
async def chat(data: ChatRequest):
    ...
    # TODO: We ask you to implement streaming the responses from the backend to the frontend
    #  over a streaming http endpoint that streams ndjson. As a pointer, you might want to look at starlettes
    #  StreamingReponse class
